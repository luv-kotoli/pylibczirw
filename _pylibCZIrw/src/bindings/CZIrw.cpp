...
PYBIND11_MODULE(_pylibCZIrw, m)
{
    py::class_<CZIreadAPI>(m, "czi_reader", py::module_local())
        ...
        .def("GetComposeMultiChannelData", &CZIreadAPI::GetComposeMultiChannelData)
        .def("GetAttachmentRawData", &CZIreadAPI::GetAttachmentRawData)
        .def("GetAttachmentNames", &CZIreadAPI::GetAttachmentNames)
        .def("GetLabelImage", &CZIreadAPI::GetLabelImage)
